...
import { PutViTri, ViTri } from "../../types/positionsTypes";
...
export const { reducer: putViTriIDReducer, actions: putViTriIDActions } =
  createSlice({
    name: "putViTriID",
    initialState,
    reducers: {
...
export const putViTriID = createAsyncThunk(
  "putViTriID",
  async (
    data: { id: string | undefined; data: PutViTri },
    { rejectWithValue }
  ) => {
    try {

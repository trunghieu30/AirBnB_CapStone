...
import { PhongThue, PostPhongThue } from "../../types/roomForRentTypes";
...
export const { reducer: postPhongThueReducer, actions: postPhongThueActions } =
  createSlice({
    name: "postPhongThue",
    initialState,
    reducers: {
...
export const postPhongThue = createAsyncThunk(
  "postPhongThue",

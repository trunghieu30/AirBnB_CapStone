...
import {
  postPhongThue,
  postPhongThueActions,
} from "../../../stores/roomForRent/POSTRoomForRentReducers";
...
const PopupThemPhongThue: React.FC<Props> = (props) => {
  ...
  const { contentPostPhongThue, errContentPostPhongThue } = useSelector(
      ...
      <div className="h-14">
        ...
        {contentPostPhongThue ? (
          <p className="text-center text-lg text-green-500 m-0">
            Thêm phòng thuê thành công!
          </p>
        ) : (
          <p className="text-center text-red-500 m-0">
            {errContentPostPhongThue}
          </p>
        )}
      </div>
      <form

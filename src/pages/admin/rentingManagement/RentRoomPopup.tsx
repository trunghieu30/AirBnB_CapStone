...
import {
  postDatPhong,
  postDatPhongActions,
} from "../../../stores/rentRoom/POSTRentReducers";
import {
  getPhongThueID,
  getPhongThueIDActions,
} from "../../../stores/roomForRent/GETRoomForRentByIdReducers";
import {
...
const PopupDatPhong: React.FC<Props> = (props) => {
  ...
  const { contentPostDatPhong, errContentPostDatPhong } = useSelector(
      ...
      >
        ...
        {ngayDi >= ngayDen && ngayDen !== 0 ? (
          <div className="flex justify-between mb-3 text-base font-semibold bg-gray-300 p-2">
            <p className="m-0">
              Tổng tiền: {contentGetPhongThueID?.giaTien}$/ngày{" "}
              <AiOutlineClose className="inline-block mb-1" />{" "}

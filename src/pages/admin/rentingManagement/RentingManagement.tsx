...
import { getPhongThueAll } from "../../../stores/roomForRent/roomForRentAllReducers";
import { getViTriAll } from "../../../stores/position/GETAllPositionsReducers";
import PopupDatPhong from "./RentRoomPopup";
import PopupCapNhatDatPhong from "./UpdateRentingPopup";
...
const QuanLyDatPhong: React.FC = () => {
  ...
  const { contentPostDatPhong } = useSelector(
    (state: RootState) => state.postDatPhongReducer
  );
  ...
  return (
    <div className="bg-white m-3 p-3">
      <p className="font-bold text-xl mb-3">
        Quản lý đặt phòng người dùng {contentGetUsersID?.id}
      </p>
      <div className="flex mb-3">
        <div>
          <img
            src={contentGetUsersID?.avatar}
            alt="..."
        ...
        <div className="pl-10 flex flex-col justify-between">
          ...
          <p className="m-0">
            Giới tính: {contentGetUsersID?.gender === true ? "Nam" : "Nữ"}
          </p>
        </div>
        <div className="pl-10 flex flex-col justify-between">
                ...
                {(() => {
                  ...
                  return (
                    <div>
                      ...
                      <p className="m-0">
                        Giá tiền: {phongThue?.giaTien}$/ngày
                      </p>
                    </div>
                  );
                })()}
      ...
      {messageDeleteDatPhong || errMessageDeleteDatPhong ? (
        <div className="fixed top-0 bottom-0 left-0 right-0 bg-black/40">
          <div className="w-80 h-40 bg-white mx-auto mt-40 shadow flex flex-col justify-center items-center">
            ...
            <button
              onClick={() =>
                dispatch(deleteDatPhongActions.removeMessageDeleteDatPhong(""))
              }

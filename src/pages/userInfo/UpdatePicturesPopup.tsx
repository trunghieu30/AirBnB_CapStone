...
import {
  postUsersUploadAvatar,
  postUsersUploadAvatarActions,
} from "../../stores/user/POSTUploadUsersAvatarReducers";
...
const PopupCapNhatAnh: React.FC<Props> = (props) => {
  ...
  const { contentPostUserUpLoadAvatar, errContentPostUserUpLoadAvatar } =
    useSelector((state: RootState) => state.postUsersUploadAvatarReducer);
      ...
      <div className="text-right">
        <button
          onClick={() => {
            ...
            dispatch(
              postUsersUploadAvatarActions.removeContentPostUserUpLoadAvatar("")
            );
            reset({
              avatar: "",
            });
